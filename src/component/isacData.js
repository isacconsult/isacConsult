  ...
  service: [
    {
      ...
      iconName: childIcon,
      serviceTitle: "Copii",
      sDetails: "Situație: copilul testează limitele.",
      sDetails1: 'ISAC: ajustezi reacția adultului → limită clară, consecventă, fără escaladare.',  
      sDetails2: 'Rezultat: comportamentul se stabilizează.',
    },
    {
      id: 2,
      iconName: teenagerIcon,
      serviceTitle: "Adolescenți",
      sDetails: "Situație: contestare constantă.",
      sDetails1: 'ISAC: schimbi poziția → mai puțină confruntare, mai multă structură.',  
      sDetails2: 'Rezultat: conflictul scade, cooperarea crește.',
    },
    {
      id: 3,
      iconName: youngIcon,
      serviceTitle: "Tineri",
      sDetails: "Situație: evitarea responsabilițătii. ",
      sDetails1: 'ISAC: clarifici așteptările si retragi susținerea neproductivă.',  
    ...
    },
    {
      ...
      iconName: adultIcon,
      serviceTitle: "Adulți",
      sDetails: "Situație: control, pasiv-agresiv, manipulare.  ",
      sDetails1: 'ISAC: modifici reacția ta → ieși din jocul lor. ',  
      sDetails2: 'Rezultat: dinamica de putere se schimbă.',
    },
    {
      id: 5,
      iconName: oldIcon,
      serviceTitle: "Persoane în vârstă",
      sDetails:  "Situație: rigiditate, rezistență. ",
      sDetails1: 'ISAC: poziționare calmă, fermă, fară confruntare inutila. ',  
      sDetails2: 'Rezultat: relație funcțională, cu limite clare.',
    },
  ],
  contact: [
    {
